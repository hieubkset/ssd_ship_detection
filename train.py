...
def parse_args():
    ...
    parser.add_argument('--lr-steps', dest='lr_refactor_step', type=str, default='1, 2, 3',
                        help='refactor learning rate at specified epochs')
    ...
    parser.add_argument('--num-example', dest='num_example', type=int, default=30673,
                        help='number of image examples')
    ...
    parser.add_argument('--class-names', dest='class_names', type=str,
                        default='ship',
                        help='string of comma separated names, or text filename') # edit for ship
