...
import os
import sys
from detect.tif_detector import Detector
...
def parse_args():
    ...
    parser.add_argument('--tif', dest='tif', type=str, default='/data/datasets/VOCdevkit/tif_test_sample.jpg')
...
def run(args, ctx):
    ...
    # run detection
    detector.detect(args.tif, args.thresh, args.iou)
